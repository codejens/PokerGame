protocol_func_map_client[52] = {
    ...
    [1] = function ( 
        ...
        --@debug_end
        local np = NetManager:get_NetPacket( 52, 1 ) 
    ...
    [2] = function ( 
        ...
        protocol_func_map:check_param_type({ { param_name = param_1_unsigned_int64, lua_type = "number" },  })
        --@debug_end
        local np = NetManager:get_NetPacket( 52, 2 ) 
        np:writeUint64( param_1_unsigned_int64 )
        NetManager:send_packet( np )
    end,
    ...
    [3] = function ( 
        ...
        --@debug_end
        local np = NetManager:get_NetPacket( 52, 3 ) 
    ...
    [10] = function ( 
        ...
        --@debug_end
        local np = NetManager:get_NetPacket( 52, 10 ) 
    ...
    [13] = function ( 
        ...
        --@debug_end
        local np = NetManager:get_NetPacket( 52, 13 ) 
...
protocol_func_map_server[52] = {
    --穿上装备返回
    --接收服务器
    [1] = function ( np )
        local var_1_unsigned_int64 = np:readUint64( ) --装备guid
        PacketDispatcher:dispather( 52, 1, var_1_unsigned_int64 )--分发数据
    end,
    ...
    [2] = function ( np )
        local var_1_unsigned_int64 = np:readUint64( ) --装备guid
        PacketDispatcher:dispather( 52, 2, var_1_unsigned_int64 )--分发数据
    end,
    ...
    [10] = function ( np )
        ...
        PacketDispatcher:dispather( 52, 10, var_1_unsigned_char, var_2_unsigned_char, var_3_int, var_4_int, var_5_unsigned_short, var_6_unsigned_short )--分发数据
    end,
    ...
    [11] = function ( np )
        ...
        PacketDispatcher:dispather( 52, 11, var_1_int )--分发数据
    end,
    ...
    [12] = function ( np )
        ...
        PacketDispatcher:dispather( 52, 12, var_1_int )--分发数据
    end,

    --清空祝福值
    --接收服务器
    [14] = function ( np )
        PacketDispatcher:dispather( 52, 14 )--分发数据
    end,
