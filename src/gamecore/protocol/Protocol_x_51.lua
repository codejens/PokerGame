    if ( protocol_func_map_server[51] == nil ) then
    ...
    --下发法阵的基础数据
    --接收服务器
    protocol_func_map_server[51][3] = function ( np )
        ...
        PacketDispatcher:dispather( 51, 3, var_1_string, var_2_unsigned_char, var_3_int, var_4_unsigned_char, var_5_int, var_6_int, var_7_int, var_8_int, var_9_int, var_10_int, var_11_struct )--分发数据
    end

    --下发法阵装备信息
    --接收服务器
    protocol_func_map_server[51][4] = function ( np )
        ...
        PacketDispatcher:dispather( 51, 4, var_1_int, var_2_unsigned_char, var_3_array )--分发数据
    end

    --下发法阵技能信息
    --接收服务器
    protocol_func_map_server[51][5] = function ( np )
        local var_1_int = np:readInt( ) --玩家id
        ...
        PacketDispatcher:dispather( 51, 5, var_1_int, var_2_unsigned_char, var_3_array )--分发数据
    end

    --学习技能返回
    --接收服务器
    protocol_func_map_server[51][13] = function ( np )
        ...
        PacketDispatcher:dispather( 51, 13, var_1_unsigned_char, var_2_array )--分发数据
    end
