...
-- ---------
-- ---------文字按钮类
-- super_class.TextButtonEx(AbstractBasePanel)
-- ---------
-- ---------
-- local function TextButtonExCreateFunction(self, width, height, x, y, text, image, topLeftWidth, topLeftHeight, topRightWidth, topRightHeight, bottomLeftWidth, bottomLeftHeight, bottomRightWidth, bottomRightHeight)
-- 	local tPosX = x
-- 	local tPosY = y
-- 	local tWidth = width
...
-- 	end
-- 	---------
-- 	self.button = CCNGBtnMulTex:buttonWithFile( 0, 0, )
...
-- ---------
-- ---------
-- function TextButtonEx:__init(fatherPanel)
-- end
-- ---------
-- ---------
-- function TextButtonEx:create(fatherPanel, x, y, width, height, text, image, type, topLeftWidth, topLeftHeight, topRightWidth, topRightHeight, bottomLeftWidth, bottomLeftHeight, bottomRightWidth, bottomRightHeight)
...
-- ---------
-- ---------设置文字
-- function TextButtonEx:setText(text)
...
-- function TextButtonEx:setFontSize(size)
-- 	if self.view ~= nil then
