...
function AlertWin:show_new_alert(panel, winObj)
...
function AlertWin:close_alert()
    ...
    if win and AlertWin.child_panel then
        ...
        -- AlertWin.child_panel:stop_timer()
        if AlertWin.winObj then
            -- AlertWin.winObj.timer:stop()
            -- AlertWin.winObj.timer = nil
            AlertWin.winObj:stop_timer()
        end
    end
    if win then
