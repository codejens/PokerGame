...
function _initScreen9GridPos()
    if not window9GridPos then
        ...
        print("_screenOffsetX,_screenOffsetY=",_screenOffsetX,_screenOffsetY)
        print("w,hw,h,hh=",w,hw,h,hh)
        -- local ws = UIScreenPos.relativeWidth
        local ws = ZXgetWinSize().width
        ...
        window9GridPos[4] = {  action = _ActionMove,
                               ...
                               CCPointMake(0, 0.5),    
                               CCPointMake(-w, hh),  
                               CCPointMake(_OFFSET, hh) 
                            }
        -------------------------------------------------------------------------
        --对话框居中
        window9GridPos[10] = {  action = nil,
        ...
        window9GridPos[11] = {  action = _ActionMove,
                               CCPointMake( w * 0.5, hh + 5),
                               CCPointMake(0.5, 0.5),
                               -- CCPointMake(ws, hh + 5),
                               CCPointMake(w * 0.5, hh + 5),
                               CCPointMake(w * 0.3, hh + 5),}
      -- }
    end 
end
