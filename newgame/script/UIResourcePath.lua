...
-- 	douFaTai =	 			UIResourcePath.FileFontLocate .. "doufatai/",			----演武场
...
-- 	lh_doufatai	=			UIResourcePath.FileFontLocate .. "lh_doufatai/",-- 演武场相关资源	
...
-- 	lh_shenqi	= 			UIResourcePath.FileFontLocate .. "lh_shenqi/",	-- 神器
-- }