...
--add by xiehande 2015-8-7 
--showType：文字排列显示方式；（可不填，默认 FONT_HORIZONTAL ）使用cocos2d定义好的 FONT_HORIZONTAL 横    FONT_VERTICAL  竖
-- 颜色：直接在lable中设置，支持内部颜色变化：例如： 传入  "#c00ff65地球#cff0000太阳" 地球蓝色  太阳红色
--=========================================
function UILabel:create_lable_2( lable, pos_x, pos_y, fontsize, alignment,showType)
