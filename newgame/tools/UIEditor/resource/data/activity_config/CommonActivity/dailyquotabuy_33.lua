...
WorkDailyQuotaBuyParam[5] = {
    ...
    [1] = {
        [1] = {
            [1] = { itemId = 64006, oldPrice = 760, newPrice = 388, },
            [2] = { itemId = 60082, oldPrice = 1800, newPrice = 688, },
        },

        [2] = {
            [1] = { itemId = 60096, oldPrice = 1500, newPrice = 688, },
            [2] = { itemId = 60097, oldPrice = 999, newPrice = 198, },
        },
    },
    [2] = {
       [1] = {
