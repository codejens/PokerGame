...
function QQVipInterface:reinit_info(panel, info, name)
    ...
    if show_year == false then
        ...
        if show_vip == false then
            ...
            panel.name_lab:setPosition( ( temp_panel_size.width - name_lab_size.width - qq_vip_year_icon_size.width ) / 2 + qq_vip_year_icon_size.width, 0 )        
        else
            ...
            panel.name_lab:setPosition( ( temp_panel_size.width - name_lab_size.width - qq_vip_icon_size.width - qq_vip_year_icon_size.width ) / 2 + qq_vip_icon_size.width + qq_vip_year_icon_size.width, 0 )
        end
    end
end
------------------------------------------------------------------
