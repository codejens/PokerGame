...
PlatformYouXiDuo.MESSAGE_TYPE	= "platform"

PlatformYouXiDuo.FUNC_CHANGE_ACCOUNT = "change_account"

PlatformYouXiDuo.FUNC_LOGIN		= "login"		--登录

PlatformYouXiDuo.FUNC_PAY		= "pay"			--支付

PlatformYouXiDuo.FUNC_TAB		= "tab"			--切换账号

PlatformYouXiDuo.FUNC_LOGIN_OUT	= "login_out"	--登出

PlatformYouXiDuo.FUNC_INIT_ROLE	= "init_role"	--传送
PlatformYouXiDuo.FUNC_QUIT		= "quit"		--退出

PlatformYouXiDuo.CODE_SUCCESS = 0

PlatformYouXiDuo.STATE_LOGIN_SUCCESS = 0 -- 成功

PlatformYouXiDuo.STATE_LOGIN_FAIL = 1	-- 失败
...
function PlatformYouXiDuo:init()
...
function PlatformYouXiDuo:get_server_filter_list()
...
function PlatformYouXiDuo:onEnterGameScene(isEnter)
...
function PlatformYouXiDuo:doLogin()

	--跳转到无平台登陆页，有平台应该调用SDK
	-- RoleModel:change_login_page( "login" )
	MUtils:toast("PlatformYouXiDuo:doLogin", 2048, 3)

	-- RoleModel:change_login_page( "login" )

	local json_table_temp = {}

	json_table_temp[ "message_type" ]	= PlatformYouXiDuo.MESSAGE_TYPE	--消息类型，必传字段

	json_table_temp[ "function_type" ] = PlatformYouXiDuo.FUNC_LOGIN
...
function PlatformYouXiDuo:get_login_url()
...
function PlatformYouXiDuo:get_servlist_url()
...
function PlatformYouXiDuo:show_logout(callbackfunc)
...
function PlatformYouXiDuo:logoutFromSelectServer(callbackfunc, reason)
...
-- function PlatformYouXiDuo:get_servlist_param()
...
function PlatformYouXiDuo:get_login_param( account, dbip, server_id )
...
function PlatformYouXiDuo:get_login_param_json( )
    return "appid="..self.appid.."&token="..self.access_token;
end
...
function PlatformYouXiDuo:getServerIP()
	...
	print("PlatformYouXiDuo:getServerIP:",_url)
...
function PlatformYouXiDuo:getPlatformPayUrl()
...
function PlatformYouXiDuo:logout(callbackfunc)
	...
	json_table_temp[ "function_type" ] = PlatformYouXiDuo.FUNC_LOGIN_OUT
...
function PlatformYouXiDuo:lost_connect( callbackfunc )
...
function PlatformYouXiDuo:failedTologinGameServer(callbackfunc)
...
function PlatformYouXiDuo:notifyZone( ... )
...
function PlatformYouXiDuo:onStartPackage(cbfunc)
...
function PlatformYouXiDuo:onStartUpdate(cbfunc)
...
function PlatformYouXiDuo:onStartGame(cbfunc)
...
function PlatformYouXiDuo:doNeedLogin()
...
function PlatformYouXiDuo:doNeedLogin_delay()

end



function PlatformYouXiDuo:OnAsyncMessage( id, msg )
	ZXLog('PlatformYouXiDuo:OnAsyncMessage', id, msg)
	print("谢汉德谢汉德谢汉德")
	require 'json/json'
...
function PlatformYouXiDuo:get_cache_url()
...
function PlatformYouXiDuo:get_package_url()
...
function PlatformYouXiDuo:getDownloadFrom()
...
function PlatformYouXiDuo:showPlatformUI(bFlag)

end


--支付
function PlatformYouXiDuo:payUICallback( info )
	...
	json_table_temp[ "function_type" ] = PlatformYouXiDuo.FUNC_PAY
	...
	json_table_temp[ "sid" ] = _serverId

	json_table_temp[ "object" ] = _privateField
...
function PlatformYouXiDuo:getLoginRet()
...
function PlatformYouXiDuo:getPayInfo()

	require "../data/chong_zhi_config"

	return ChongZhiConf.youxiduo
...
function PlatformYouXiDuo:share(info)
...
function PlatformYouXiDuo:setLoginRet(uid,psw)
...
function PlatformYouXiDuo:open_user_center()
...
function PlatformYouXiDuo:onLoginResult( err, data )
...
-- --退出游戏
-- function PlatformYouXiDuo:exit()
-- 	local json_table_temp = {}
