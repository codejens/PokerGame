	...
	EntityConfig.SELECT_COLOR_ENTITY =     {
		...
		[EntityConfig.TYPE_MONSTER] = { 255, 0, 0 , 125 },
		[EntityConfig.TYPE_NPC] = 	  { 56, 255, 51 , 125 },
		[EntityConfig.TYPE_MOVING_NPC] =  { 56, 255, 51 , 125 }
	}
	EntityConfig.SELECT_COLOR_DEFAULT =  { 175, 255, 255 , 125 }
	...
	EntityConfig.ACTOR_STATE_CASTELLAN		= 0x00100000	-- 21: 天元城主
	...
	--	{"step", "float",},									-- 自己添加的，非服务器属性，步进，(每一帧的移动速度), 用于减少运算量
	--  {"model", "ZXEntity",},								-- 自己添加的，非服务器属性，控制每个模型的动作行为的指针
	--  {"type", "int"},									-- 实体类型
	--  {"name", "string"},									-- 实体名称
		[0] = {"id", "uint",},								-- 实体id
		{"x", "int",},										-- 实体坐标X
		...
		{"honor", "int"},									-- 荣誉值
		{"super", "int"},									-- 变身 --高16：培养等级 低16：变身ID
		{"gatherValue", "uint",},							-- 采集体力
		...
		{"headTitle", "int",},								-- 头衔
		{"mountRideType", "int",},							-- 坐骑飞行类型
		{"practiceEffect", "int",},							-- 玩家打坐的时候的特效
		{"equipScore", "uint",},							-- 玩家的装备的总分
	}

	EntityConfig.PLAYER_AUTO_RIDE_DST = { 480, 320 }
	-- 检查实体是否宠物
