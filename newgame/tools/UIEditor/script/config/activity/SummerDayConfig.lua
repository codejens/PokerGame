...
--创建光棍节活动的配置单体对象
SummerDayConfig = BaseCommonConfig(nil)
...
--作者：陈亮
--时间：2014.10.31
function SummerDayConfig:refreshActivityParam(activityId)
	local t_activityParam = nil
	require "../data/activity_config/CommonActivity/SummerDayParam"
	t_activityParam = SummerDayParam
