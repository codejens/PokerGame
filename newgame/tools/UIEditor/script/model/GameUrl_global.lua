...
function GameUrl_global:getServerIP()
	...
	if not config then
		return PlatformInterface:getServerIP()
	else
...
function GameUrl_global:getPlatformConfig()
	print('getPlatformConfig',Target_Platform)
	print('getPlatformConfig',GameUrl_PlatformConfig[Target_Platform].share_url)
