...
local STRING_SOCKETINT= { LangGameString[485],  -- [485]='#cffff00无法初始化网络模块'
						  LangGameString[486],  -- [486]='#cffff00请尝试重启游戏'
						  LangGameString[487]} -- [487]='#cffff00如无法解决请重新安装游戏'

local STRING_NO_NETWORK1 = 	LangGameString[488] -- [488]='#cffff00无法连接到网络或信号弱'
local STRING_NO_NETWORK2 =  LangGameString[489] -- [489]='#cffff00请开启网络连接'
...
local function start_game( pack )
	...
	elseif result == 3 then
        ...
        local function time_callback( )
        	...
        	---new
        	-- NetManager:disconnect()
        	-- RoleModel:show_notice( "您的账号已经登陆或者没有正常退出。请重试!" )
