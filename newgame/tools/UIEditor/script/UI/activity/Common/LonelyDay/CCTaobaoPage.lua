...
--创建圣诞节淘宝树页面类
super_class.CTaobaoPage(MovePlacePage)
...
--作者：肖进超
--时间：2014.12.17
function CTaobaoPage:destroy()
	--获取父类
	local t_pageParent = CTaobaoPage.super
	--调用父类的析构函数
...
--作者：肖进超
--时间：2014.12.17
function CTaobaoPage:showPageAction()
	LonelyDayModel:showCTaobaoPage(self._isInit)
end
...
--作者：肖进超
--时间：2014.12.17
function CTaobaoPage:forwardButtonAction()
...
--作者：肖进超
--时间：2014.12.17
function CTaobaoPage:transformButtonAction()
