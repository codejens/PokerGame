...
--创建圣诞节淘宝树页面类
super_class.WorkTaobaoPage(MovePlacePage)
...
--作者：肖进超
--时间：2014.12.17
function WorkTaobaoPage:__init()
	--创建私有变量
...
--作者：肖进超
--时间：2014.12.17
function WorkTaobaoPage:destroy()
	--获取父类
	local t_pageParent = WorkTaobaoPage.super
	--调用父类的析构函数
...
--作者：肖进超
--时间：2014.12.17
function WorkTaobaoPage:showPageAction()
	WorkDayModel:showCTaobaoPage(self._isInit)
end
...
--作者：肖进超
--时间：2014.12.17
function WorkTaobaoPage:forwardButtonAction()
...
--作者：肖进超
--时间：2014.12.17
function WorkTaobaoPage:transformButtonAction()
