...
--创建鲜花排行榜活动页面类
super_class.WhiteSendFollowQueuePage(QueuePage)
...
--作者：陈亮
--时间：2014.10.27
function WhiteSendFollowQueuePage:__init()
...
function WhiteSendFollowQueuePage:refreshData()
	local send_flower_info = SendFlowerModel:get_send_flower_info()
	-- 刷新送花数量
...
--作者：陈亮
--时间：2014.10.27
function WhiteSendFollowQueuePage:destroy()
	--获取父类
	local t_pageParent = WhiteSendFollowQueuePage.super
	--调用父类的析构函数
...
function WhiteSendFollowQueuePage:showPageAction()
	ValentineWhiteDayModel:showSendFollowQueuePage(self._isInit)
	-- 请求新数据
...
--作者：陈亮
--时间：2014.10.27
function WhiteSendFollowQueuePage:gotoQueue()
	ValentineWhiteDayModel:gotoSendFollowQueueWin(9)
end