...
---------
---------复选按钮
super_class.ZCheckBox(ZAbstractBasePanel)
---------
---------
function ZCheckBox:registerScriptFun()
...
---------
---------
function ZCheckBox:__init(fatherPanel)
	self.click_num = 0
end
---------
---------
function ZCheckBox:create(fatherPanel, image, fun, x, y, width, height, topLeftWidth, topLeftHeight, topRightWidth, topRightHeight, bottomLeftWidth, bottomLeftHeight, bottomRightWidth, bottomRightHeight)
	local sprite = ZCheckBox(fatherPanel)
...
---------
---------添加对应状态图片
function ZCheckBox:addImage(state, image)
	if self.view ~= nil then
...
---------
---------添加对应状态变灰图片
function ZCheckBox:addGrayImage(state, image)
	if self.view ~= nil then
...
---------
---------
function ZCheckBox:setCurState(state)
...
---------
---------
function ZCheckBox:getClickNum()
