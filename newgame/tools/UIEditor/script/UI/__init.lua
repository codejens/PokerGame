...
-- require "UI/chat/ChatPrivateScroll"			--
-- require "UI/chat/ChatWin"					--聊天
-- require "UI/chat/ChatPrivateChatWin"		--聊天私聊
-- require "UI/chat/ChatFaceWin"				--聊天表情
-- require "UI/chat/ChatFlowerWin"				--聊天鲜花
-- require "UI/chat/ChatChanelSelectWin"		--聊天频道选择
-- require "UI/chat/ChatThankWin"				--鲜花感谢界面
-- require "UI/chat/ChatXZWin"					--仙宗聊天
...
-- require "UI/wing/WingLeftWin" 					-- 翅膀系统
-- require "UI/wing/WingRightWin"
-- require "UI/wing/WingInfoPageLeft"
-- require "UI/wing/WingInfoPageRight"
-- require "UI/wing/WingLvUpPageLeft"
-- require "UI/wing/WingLvUpPageRight"
-- require "UI/wing/WingUpgradePageLeft"
-- require "UI/wing/WingUpgradePageRight"
-- require "UI/wing/WingShapePage"
-- require "UI/wing/WingSkillPage"
-- require "UI/wing/WingGetWin"

-- require "UI/wing/WingWin"					-- tjxs翅膀主界面
-- require "UI/wing/WingInfoPage"				-- tjxs翅膀信息界面
-- require "UI/wing/WingUpGradePage"			-- tjxs翅膀升级界面
-- require "UI/wing/WingUpDegreePage"			-- tjxs翅膀升阶界面
-- require "UI/wing/WingSkillWin"				-- tjxs翅膀技能面板
-- require "UI/wing/WingSkillItem"				-- tjxs翅膀技能item

-- require "UI/wing/WingOtherWin"				-- tjxs查看他人翅膀主界面
-- require "UI/wing/WingOtherInfoPage"			-- tjxs查看他人翅膀信息分页
...
-- require "UI/VIP/VIPSysWin"					--vip，仙尊系统
...
-- require "UI/questionactivity/QuestionActivityWin" --答题活动窗口
...
-- require "UI/goal/GoalWin";					-- 目标窗口
-- require "UI/goal/GoalLeftPage"				-- 目标左面板
-- require "UI/goal/GoalRightPage"				-- 目标右面板
...
-- require "UI/main/MenusPanelT"	    		--功能菜单按钮点击弹出的框
-- require "UI/main/ActivityMenusPanel"	    --活动菜单按钮点击弹出的框
-- require "UI/main/BuffView"					-- buff控件
-- require "UI/main/TeamBtnsPanel"				-- 任务快捷栏队伍页的panel
-- -- require "UI/main/XDHTongjiActionPanel"				-- 仙道會点击统计面板后弹出的下注、扔鸡蛋等行为的操作面板
-- require "UI/main/MenusGrow"				--成长之路
...
-- require "UI/task/TaskWin"	-- 任务面板
-- require "UI/task/TaskChapterPage"	-- 任务面板分页
-- require "UI/task/NPCDialog" -- NPC对话框
-- require "UI/task/ZYCMWin"                   	-- 斩妖除魔窗口
-- require "UI/task/HSXNWin"                   	-- 护送仙女窗口
-- require "UI/task/PaoHuanWin"                   	-- 跑环窗口
...
-- require "UI/activity/FBResultWin"
...
-- require "UI/activity/ZhanYiFuben"               --分层副本
...
-- require "UI/forge/strengthenpage/StrengthenL"
-- require "UI/forge/strengthenpage/StrengthenRD"
-- require "UI/forge/strengthenpage/StrengthenRU"
-- require "UI/forge/ForgeCommon"
-- require "UI/forge/ShengJie"
-- require "UI/forge/ForgeDialog"
-- require "UI/forge/TiPin"
-- require "UI/forge/Transfer"
-- require "UI/forge/ZhuangBeiXiLian"
-- require "UI/forge/SynthConfirm"
-- require "UI/forge/ZhiZunXiLianWin"
...
-- require "UI/baguadigong/BaguadigongWin"		--八卦地宫
