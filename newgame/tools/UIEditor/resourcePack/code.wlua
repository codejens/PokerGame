...
function console.do_string(cmd)
  console.print_command(cmd)
	...
	function toustring(s)
		return cd:iconv(tostring(s))
	end

	local t = FreeImageToolBox.string2Unicode(toustring(cmd))
	for i,v in pairs(t) do
		local code = string.format('%x',v)
		print(code,v)
	end
	local s = FreeImageToolBox.int2string(tonumber('0x'..'8b81e6'))
